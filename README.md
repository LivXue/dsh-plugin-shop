...
dsh plugin --profile web add dsh-plugin-shop@0.5.3
# or straight through npx, nothing installed:
npx -y @deepseek-ai/dsh plugin --profile web add dsh-plugin-shop@0.5.3
```
...
dsh plugin --profile <profile> add dsh-plugin-shop@0.5.3
