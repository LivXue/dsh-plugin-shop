...
dsh plugin --profile web add dsh-plugin-shop@0.7.1
# 或全程走 npx，什么都不装：
npx -y @deepseek-ai/dsh plugin --profile web add dsh-plugin-shop@0.7.1
```
...
dsh plugin --profile <profile> add dsh-plugin-shop@0.7.1
