...
export const zh = {
  ...
  incompatibleUpdateBadge: '更新不兼容',
  incompatibleDetail: '缺少组件/插件：{modules}\n此插件可能是为其他版本的 DSH 设计的。',
  incompatibleUpdateDetail: '缺少组件/插件：{modules}\n此更新可能是为其他版本的 DSH 设计的。',
...
export const en = {
  ...
  incompatibleUpdateBadge: 'Update Incompatible',
  incompatibleDetail: 'Missing components/plugins: {modules}\nThis plugin may be designed for another DSH version.',
  incompatibleUpdateDetail: 'Missing components/plugins: {modules}\nThis update may be designed for another DSH version.',
